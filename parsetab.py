...
_lr_productions = [
  ...
  ('new_scope -> <empty>','new_scope',0,'p_new_scope','parser_build.py',38),
  ('scope -> new_scope LBRAKETS multiple_statements RBRAKETS','scope',4,'p_scope','parser_build.py',47),
  ('scope -> new_scope LBRAKETS expression RBRAKETS','scope',4,'p_scope','parser_build.py',48),
  ('expression -> expression PLUS expression','expression',3,'p_expression','parser_build.py',56),
  ('expression -> expression MINUS expression','expression',3,'p_expression','parser_build.py',57),
  ('expression -> expression TIMES expression','expression',3,'p_expression','parser_build.py',58),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','parser_build.py',59),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression','parser_build.py',60),
  ('expression -> term','expression',1,'p_expression','parser_build.py',61),
  ('term -> instance','term',1,'p_term','parser_build.py',70),
  ('term -> factor','term',1,'p_term','parser_build.py',71),
  ('instance -> type ID','instance',2,'p_instance','parser_build.py',83),
  ('instance -> ID','instance',1,'p_instance','parser_build.py',84),
  ('factor -> NUMBER','factor',1,'p_factor','parser_build.py',108),
  ('type -> INT','type',1,'p_type','parser_build.py',114),
  ('type -> FLOAT','type',1,'p_type','parser_build.py',115),
  ('type -> STRING','type',1,'p_type','parser_build.py',116),
  ('litstring -> LITSTRING','litstring',1,'p_litstring','parser_build.py',125),
  ('adress -> instance ADRESS factor SEMICOLON','adress',4,'p_adress','parser_build.py',133),
  ('adress -> instance ADRESS litstring SEMICOLON','adress',4,'p_adress','parser_build.py',134),
  ('adress -> instance ADRESS expression SEMICOLON','adress',4,'p_adress','parser_build.py',135),
  ('return -> RETURN expression SEMICOLON','return',3,'p_return','parser_build.py',160),
  ('return -> RETURN SEMICOLON','return',2,'p_return','parser_build.py',161),
  ('condition -> expression OR expression','condition',3,'p_condition','parser_build.py',169),
  ('condition -> expression NOT expression','condition',3,'p_condition','parser_build.py',170),
  ('condition -> expression AND expression','condition',3,'p_condition','parser_build.py',171),
  ('condition -> expression EQUAL expression','condition',3,'p_condition','parser_build.py',172),
  ('condition -> condition OR condition','condition',3,'p_condition','parser_build.py',173),
  ('condition -> condition NOT condition','condition',3,'p_condition','parser_build.py',174),
  ('condition -> condition AND condition','condition',3,'p_condition','parser_build.py',175),
  ('condition -> expression NOTEQUAL expression','condition',3,'p_condition','parser_build.py',176),
  ('condition -> expression GREATER expression','condition',3,'p_condition','parser_build.py',177),
  ('condition -> expression LESS expression','condition',3,'p_condition','parser_build.py',178),
  ('condition -> expression GREATEREQUAL expression','condition',3,'p_condition','parser_build.py',179),
  ('condition -> expression LESSEQUAL expression','condition',3,'p_condition','parser_build.py',180),
  ('condition -> LPAREN condition RPAREN','condition',3,'p_condition','parser_build.py',181),
  ('condition -> NOT condition','condition',2,'p_condition','parser_build.py',182),
  ('multiple_statements -> multiple_statements statement','multiple_statements',2,'p_multiple_statements','parser_build.py',191),
  ('multiple_statements -> statement','multiple_statements',1,'p_multiple_statements','parser_build.py',192),
  ('statement -> expression SEMICOLON','statement',2,'p_statement','parser_build.py',202),
  ('statement -> if','statement',1,'p_statement','parser_build.py',203),
  ('statement -> for','statement',1,'p_statement','parser_build.py',204),
  ('statement -> while','statement',1,'p_statement','parser_build.py',205),
  ('statement -> print','statement',1,'p_statement','parser_build.py',206),
  ('statement -> adress','statement',1,'p_statement','parser_build.py',207),
  ('statement -> return','statement',1,'p_statement','parser_build.py',208),
  ('param -> param COMMA param','param',3,'p_param','parser_build.py',216),
  ('param -> term','param',1,'p_param','parser_build.py',217),
  ('if -> IF LPAREN condition RPAREN scope','if',5,'p_if','parser_build.py',227),
  ('if -> IF LPAREN condition RPAREN scope elseif','if',6,'p_if','parser_build.py',228),
  ('if -> IF LPAREN condition RPAREN scope ELSE scope','if',7,'p_if','parser_build.py',229),
  ('elseif -> ELSEIF LPAREN condition RPAREN scope','elseif',5,'p_elseif','parser_build.py',240),
  ('elseif -> ELSEIF LPAREN condition RPAREN scope elseif','elseif',6,'p_elseif','parser_build.py',241),
  ('elseif -> ELSEIF LPAREN condition RPAREN scope ELSE scope','elseif',7,'p_elseif','parser_build.py',242),
  ('print -> PRINT LPAREN litstring RPAREN SEMICOLON','print',5,'p_print','parser_build.py',255),
  ('print -> PRINT LPAREN expression RPAREN SEMICOLON','print',5,'p_print','parser_build.py',256),
  ('print -> PRINT LPAREN litstring COMMA param RPAREN SEMICOLON','print',7,'p_print','parser_build.py',257),
  ('for -> FOR LPAREN for_initilizer condition SEMICOLON expression RPAREN scope','for',8,'p_for','parser_build.py',267),
  ('for_initilizer -> adress','for_initilizer',1,'p_for_initializer','parser_build.py',274),
